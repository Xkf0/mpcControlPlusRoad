...
// mpc
//void C_MPC_CONTROL::calculate_Q_R()
//{
...
//        if (i % 2 == 0)
//        {
//            m_QWeightStateOffset(i, i) = 35 * d_qWeightStateOffset;
//        }
//        else
//        {
...
//        if (i % 2 == 0)
//        {
//            m_RWeightControlIncrement(i, i) = 20 * d_rWeightControlIncrement;
//        }
//        else
//        {
//            m_RWeightControlIncrement(i, i) = 1 * d_rWeightControlIncrement;
//        }
//    }
//}
//void C_MPC_CONTROL::calculate_Q_R()
...
//    std::future<Eigen::VectorXd> future = std::async(std::launch::async, [&]{
//        return c_min_j.calculate_deltaUt_Jmin();
//    });

//    // Wait for 1 second
//    std::chrono::milliseconds span(1000);
//    Eigen::VectorXd _v_deltaUt;
//    if(future.wait_for(span) == std::future_status::timeout)
//    {
//        // If the function takes more than 1 second, use Zero vector
//        _v_deltaUt = Eigen::VectorXd::Zero(i_m * i_Nc);
//        std::cout << ", Error: MinJ,";
//    }
//    else
//    {
//        // Otherwise, get the result from the thread
//        _v_deltaUt = future.get();
//    }
...
//    std::cout << " p_u: " << p_u[0] << ", " << p_u[1] << ";";
//    std::cout << " p_uRef: " << p_uRef[0] << ", " << p_uRef[1] << ";";
//    std::cout << " p_chi: " << p_chi[0] << ", " << p_chi[1] << ";";
//    std::cout << " p_chiRef: " << p_chiRef[0] << ", " << p_chiRef[1] << ";";
